...
Details: the captions appear as opaque text on a semi-transparent banner on the bottom edge of the photos when viewed from the full page post or event, not the card. Implementation is done but there is no entry point to add captions. 
